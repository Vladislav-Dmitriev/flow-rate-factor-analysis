...
def test_calc_flow_rate_mfrac():
    ...
    expected_df = pd.read_csv(f"{_path}/expected_Q_segmentation.csv")
    ...
    actual_df.to_csv(f"{_path}/actual_Q_segmentation.csv", index=False)
    eq_by_mape(actual_df, expected_df, skip={'t'})


# @pytest.mark.skip
def test_calc_p_bhp_mfrac():
    expected_df = pd.read_csv(f'{_path}/expected_P_segmentation.csv')
    ...
    actual_df = pd.DataFrame(actual)
    actual_df.to_csv(f'{_path}/actual_P_segmentation.csv', index=False)
    eq_by_mape(actual_df, expected_df, skip={'t'})
